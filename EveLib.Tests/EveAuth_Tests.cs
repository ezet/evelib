...
namespace eZet.EveLib.Test {
    ...
    public class EveAuth_Tests {
        ...
        private readonly EveSso _eveSso = new EveSso();

        [TestMethod]
        public void GetAuthorizatinLink() {
            var response = _eveSso.CreateAuthLink(clientId, "/", CrestScope.PublicData);
        ...
        public void Authenticate() {
            var response = _eveSso.Authenticate(EncodedKey, authCode).Result;
