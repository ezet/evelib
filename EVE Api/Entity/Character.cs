...
namespace eZet.Eve.EveApi.Entity {
    ...
    public class Character : EveApiEntity {
        ...
        public XmlResponse<KillLog> GetKillLog(long killId = 0) {
            ...
            var postString = killId != 0 ? WebHelper.GeneratePostString(ApiKey, "characterId", CharacterId, "beforeKillID", killId)
                : WebHelper.GeneratePostString(ApiKey, "characterId", CharacterId);
        ...
        public XmlResponse<NotificationTexts> GetNotificationTexts() {
            ...
            var postString = WebHelper.GeneratePostString(ApiKey, "characterId", CharacterId, "accountKey", AccountKey);
        ...
        public XmlResponse<WalletJournal> GetWalletJournal(int count = 50, long fromId = 0) {
            ...
            var postString = fromId == 0
                ? WebHelper.GeneratePostString(ApiKey, "characterId", CharacterId, "accountKey", AccountKey, "rowCount", count)
                : WebHelper.GeneratePostString(ApiKey, "characterId", CharacterId, "accountKey", AccountKey, "rowCount", count,
                    "fromID", fromId);
